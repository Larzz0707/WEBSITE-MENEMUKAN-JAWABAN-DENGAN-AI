...
const Api_url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyCpR5JH2VlWuUD3CqtdSRH8a_LZ5S4rdtw";
      ...
      "contents": [
        {
          "parts": [
            {
              "text": "Berikan jawaban dalam bahasa Indonesia: selesaikan masalah matematika berikut dengan langkah-langkah yang benar.",
            },
            {
              "inline_data": {
